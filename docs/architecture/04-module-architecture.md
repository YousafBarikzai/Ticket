...
| MOD-09 Knowledge, search, AI | `modules/knowledge`, `modules/search`, `modules/ai` | KnowledgeArticle, ArticleVersion, ArticleFeedback, DecisionTree, SearchDocument; AiPrompt, AiPromptVersion, AiEvalDataset, AiEvalCase, AiEvalRun, AiBudget, AiJob, AiSuggestion | `ArticleService`, `SearchService`, `Indexer`, `callModel` (the gateway), `suggestionService`, `promptService`, `evalService`, `aiBudgetService` | `knowledge.article.*`, `ai.suggestion.created`, `ai.budget.threshold` | `ticket.*`, `knowledge.*`, `catalogue.item.published`, `asset.*`, `knownerror.published` | MOD-04, MOD-01, MOD-13, MOD-15, MOD-14 |

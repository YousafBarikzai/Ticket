...
| MOD-10 Assets and CMDB | `modules/assets` *(E1, PH-4)* | CiClass, ConfigurationItem, CiRelationship, AssetModel, Asset, AssetAssignment, AffectedCi *(E1)*; Contract, Warranty, Supplier, DiscoverySource, ReconciliationRule, ReconciliationRun *(E2)* | `ciService`, `assetService`, `impactService`, `linkService` *(E1)*; `ReconciliationService` *(E2)* | `ci.registered`, `ci.status.changed`, `ci.retired`, `asset.assigned`, `asset.retired` | nothing, deliberately *(E1)*; `user.deactivated`, `import.job.completed` *(E2)* | MOD-01, MOD-04, MOD-05; MOD-14, MOD-24 for E2 |
